...
module.exports = {
    ...
    SONGU: process.env.SONGU === undefined ? '✮⃝🎸ƦUÐҤƦλ UPŁØλÐł₦G ¥ØUƦ $Ø₦G✮⃝🎧' : process.env.SONGU,
    ...
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'ᴘʀɪɴᴄᴇ ʀᴜᴅʜ' : process.env.OWNER_SHIP,
